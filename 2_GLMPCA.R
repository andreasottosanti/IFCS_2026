...
selected <- as.matrix(x@metadata$glmpca$factors[,1:selected_pca])
...
saveRDS(res, file = "Results/perlaRun_GLMPCA.RDS")
# res <- readRDS(file = "Results/perlaRun_GLMPCA.RDS")
...
saveRDS(x, file = "Results/GLMPCA.RDS")
